...
<body class="app">
  ...
  if ($id > 0) {
    $query = "SELECT * FROM daftar_utang WHERE id = ?";
    ...
    if ($stmt = $conn->prepare($query)) {
      ...
      if ($data = $result->fetch_assoc()) {
        ...
        $nama_debitur = $data['nama_debitur']; // Nama file yang sudah diupload
        $jumlah = $data['jumlah'];
        $status = $data['status'];
      } else {
            ...
            <table cellpadding="10">
              ...
              <form class="app-search-form" method="post" enctype="multipart/form-data">
                ...
                <tr>
                  ...
                  <td>
                    <input type="text" class="form-control" id="nama_debitur" name="nama_debitur" value="<?php echo $nama_debitur; ?>" required />
                  </td>
                </tr>
                <tr>
                  <td>
                ...
                <tr>
                  <td>
                    <button name="edit_utang" type="submit" class="btn app-btn-primary w-100 theme-btn mx-auto">Edit Data</button>
                  </td>
                </tr>
              </form>
              <!-- End of form input -->
